...
const TEXT = Object.freeze({
  es: {
    ...
    replayKicker: "REINCIDENCIA DEPORTIVA · CERO APRENDIZAJE",
    replayTitle: "¿Otra humillación?",
    replayCopy: "El marcador volverá a cero. Tu reputación, por desgracia, seguirá exactamente donde la has dejado.",
    replayCancel: "Saborear la victoria",
    replayConfirm: "Sí, preparar revancha",
  ...
  en: {
    ...
    replayKicker: "SPORTING RELAPSE · NOTHING LEARNED",
    replayTitle: "Ready for another humiliation?",
    replayCopy: "The scoreboard will return to zero. Your reputation, unfortunately, will remain exactly where you left it.",
    replayCancel: "Enjoy the victory",
    replayConfirm: "Yes, prepare a rematch",
